...
DEFAULT_CRITICAL_FLOORS: Final[dict[str, tuple[float, float]]] = {
    ...
    "norax/dispatch/deep_research.py": (100.0, 100.0),
    ...
    "norax/prompt/assembler.py": (100.0, 100.0),
    ...
    "norax/runtime/delivery.py": (100.0, 100.0),
    "norax/runtime/health.py": (100.0, 100.0),
    "norax/runtime/history.py": (100.0, 100.0),
    "norax/runtime/lifecycle.py": (74.0, 71.0),
    "norax/runtime/model_management.py": (100.0, 100.0),
    "norax/runtime/operations.py": (100.0, 100.0),
    "norax/runtime/session.py": (100.0, 100.0),
